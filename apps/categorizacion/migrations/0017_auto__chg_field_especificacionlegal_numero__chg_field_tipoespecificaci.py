...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EspecificacionLegal.numero'
        db.alter_column(u'categorizacion_especificacionlegal', 'numero', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'TipoEspecificacion.abreviacion'
        db.alter_column(u'categorizacion_tipoespecificacion', 'abreviacion', self.gf('django.db.models.fields.CharField')(default=2, unique=True, max_length=5))

    def backwards(self, orm):

        # Changing field 'EspecificacionLegal.numero'
        db.alter_column(u'categorizacion_especificacionlegal', 'numero', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'TipoEspecificacion.abreviacion'
        db.alter_column(u'categorizacion_tipoespecificacion', 'abreviacion', self.gf('django.db.models.fields.CharField')(unique=True, max_length=5, null=True))
