...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SubseccionConfig.creado_pst'
        db.delete_column(u'categorizacion_subseccionconfig', 'creado_pst')

        # Adding field 'SubseccionConfig.creeado_en'
        db.add_column(u'categorizacion_subseccionconfig', 'creeado_en',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Solicitud'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SubseccionConfig.creado_pst'
        db.add_column(u'categorizacion_subseccionconfig', 'creado_pst',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SubseccionConfig.creeado_en'
        db.delete_column(u'categorizacion_subseccionconfig', 'creeado_en_id')
    ...
    models = {
        ...
        u'categorizacion.subseccionconfig': {
            ...
            'creeado_en': ('mintur.fields.BigForeignKey', [], {'to': u"orm['categorizacion.Solicitud']", 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
