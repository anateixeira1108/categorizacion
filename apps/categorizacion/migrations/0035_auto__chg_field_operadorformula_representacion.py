...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OperadorFormula.representacion'
        db.alter_column(u'categorizacion_operadorformula', 'representacion', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'OperadorFormula.representacion'
        db.alter_column(u'categorizacion_operadorformula', 'representacion', self.gf('django.db.models.fields.CharField')(max_length=1))
