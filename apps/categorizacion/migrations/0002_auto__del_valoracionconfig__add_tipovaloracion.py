...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TipoValoracion'
        db.create_table(u'categorizacion_tipovaloracion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('abreviacion', self.gf('django.db.models.fields.CharField')(unique=True, max_length=5)),
        ))
        db.send_create_signal(u'categorizacion', ['TipoValoracion'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'TipoValoracion'
        db.delete_table(u'categorizacion_tipovaloracion')
