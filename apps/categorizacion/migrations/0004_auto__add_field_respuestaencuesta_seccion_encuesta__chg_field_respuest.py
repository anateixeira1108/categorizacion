...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RespuestaEncuesta.seccion_encuesta'
        db.add_column(u'categorizacion_respuestaencuesta', 'seccion_encuesta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categorizacion.SeccionEncuesta']),
                      keep_default=False)


        # Changing field 'RespuestaEncuesta.observacion'
        db.alter_column(u'categorizacion_respuestaencuesta', 'observacion', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'RespuestaEncuesta.seccion_encuesta'
        db.delete_column(u'categorizacion_respuestaencuesta', 'seccion_encuesta_id')


        # Changing field 'RespuestaEncuesta.observacion'
        db.alter_column(u'categorizacion_respuestaencuesta', 'observacion', self.gf('django.db.models.fields.TextField')(default=1, max_length=255))
