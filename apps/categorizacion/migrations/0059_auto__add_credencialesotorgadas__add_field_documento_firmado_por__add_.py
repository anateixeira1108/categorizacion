...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CredencialesOtorgadas'
        db.create_table(u'categorizacion_credencialesotorgadas', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('mintur.fields.BigForeignKey')(to=orm['cuentas.MinturUser'], null=True)),
            ('tiene_firma_delegada', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('coletilla', self.gf('django.db.models.fields.TextField')(max_length=500)),
            ('cargo', self.gf('django.db.models.fields.CharField')(max_length=150, null=True)),
            ('creado_el', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'categorizacion', ['CredencialesOtorgadas'])

        # Adding field 'Documento.firmado_por'
        db.add_column(u'categorizacion_documento', 'firmado_por',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['cuentas.MinturUser'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Documento.firmado_el'
        db.add_column(u'categorizacion_documento', 'firmado_el',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Documento.archivo_firmado'
        db.add_column(u'categorizacion_documento', 'archivo_firmado',
                      self.gf('utils.validate_files.ContentTypeRestrictedFileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Documento.nombre_archivo_firmado'
        db.add_column(u'categorizacion_documento', 'nombre_archivo_firmado',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Documento.coletillado'
        db.add_column(u'categorizacion_documento', 'coletillado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Documento.coletillado_el'
        db.add_column(u'categorizacion_documento', 'coletillado_el',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CredencialesOtorgadas'
        db.delete_table(u'categorizacion_credencialesotorgadas')

        # Deleting field 'Documento.firmado_por'
        db.delete_column(u'categorizacion_documento', 'firmado_por_id')

        # Deleting field 'Documento.firmado_el'
        db.delete_column(u'categorizacion_documento', 'firmado_el')

        # Deleting field 'Documento.archivo_firmado'
        db.delete_column(u'categorizacion_documento', 'archivo_firmado')

        # Deleting field 'Documento.nombre_archivo_firmado'
        db.delete_column(u'categorizacion_documento', 'nombre_archivo_firmado')

        # Deleting field 'Documento.coletillado'
        db.delete_column(u'categorizacion_documento', 'coletillado')

        # Deleting field 'Documento.coletillado_el'
        db.delete_column(u'categorizacion_documento', 'coletillado_el')
    ...
    models = {
        ...
        u'categorizacion.documento': {
            ...
            'archivo_firmado': ('utils.validate_files.ContentTypeRestrictedFileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'nombre_archivo_firmado': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
