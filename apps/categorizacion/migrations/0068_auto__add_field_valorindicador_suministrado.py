...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ValorIndicador.suministrado'
        db.add_column(u'categorizacion_valorindicador', 'suministrado',
                      self.gf('django.db.models.fields.NullBooleanField')(default=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ValorIndicador.suministrado'
        db.delete_column(u'categorizacion_valorindicador', 'suministrado')
    ...
    models = {
        ...
        u'categorizacion.valorindicador': {
            ...
            'respuesta_config': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['categorizacion.RespuestaConfig']"}),
            'suministrado': ('django.db.models.fields.NullBooleanField', [], {'default': 'True', 'null': 'True', 'blank': 'True'})
        },
