...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EspecificacionLegal'
        db.create_table(u'categorizacion_especificacionlegal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('identificador_legal', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('numero', self.gf('django.db.models.fields.FloatField')()),
            ('contenido', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ...
            ('documento_asociado', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.TipoDocumentoCompuesto'])),
            ('tipo_especificacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.TipoEspecificacion'])),
        ))
        db.send_create_signal(u'categorizacion', ['EspecificacionLegal'])

        # Adding model 'TipoEspecificacion'
        db.create_table(u'categorizacion_tipoespecificacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
        ))
        db.send_create_signal(u'categorizacion', ['TipoEspecificacion'])


    def backwards(self, orm):
        # Deleting model 'EspecificacionLegal'
        db.delete_table(u'categorizacion_especificacionlegal')

        # Deleting model 'TipoEspecificacion'
        db.delete_table(u'categorizacion_tipoespecificacion')
    ...
    models = {
        ...
        u'categorizacion.especificacionlegal': {
            ...
            'contenido': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'numero': ('django.db.models.fields.FloatField', [], {}),
