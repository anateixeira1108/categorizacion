...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Documento.eliminado'
        db.add_column(u'categorizacion_documento', 'eliminado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Documento.eliminado'
        db.delete_column(u'categorizacion_documento', 'eliminado')
