...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Funcionario', fields ['user']
        db.create_unique(u'categorizacion_funcionario', ['user_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Funcionario', fields ['user']
        db.delete_unique(u'categorizacion_funcionario', ['user_id'])
