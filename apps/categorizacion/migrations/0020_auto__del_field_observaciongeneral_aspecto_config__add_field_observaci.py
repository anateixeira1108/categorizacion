...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ObservacionGeneral.aspecto_config'
        db.delete_column(u'categorizacion_observaciongeneral', 'aspecto_config_id')

        # Adding field 'ObservacionGeneral.subseccion'
        db.add_column(u'categorizacion_observaciongeneral', 'subseccion',
                      self.gf('mintur.fields.BigForeignKey')(default=2, to=orm['categorizacion.Subseccion']),
                      keep_default=False)

        # Adding field 'Subseccion.subs_imagen'
        db.add_column(u'categorizacion_subseccion', 'subs_imagen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ObservacionGeneral.aspecto_config'
        db.add_column(u'categorizacion_observaciongeneral', 'aspecto_config',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.AspectoFundamentalConfig'], null=True),
                      keep_default=False)

        # Deleting field 'ObservacionGeneral.subseccion'
        db.delete_column(u'categorizacion_observaciongeneral', 'subseccion_id')

        # Deleting field 'Subseccion.subs_imagen'
        db.delete_column(u'categorizacion_subseccion', 'subs_imagen')
