...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubseccionConfig.suministrado'
        db.add_column(u'categorizacion_subseccionconfig', 'suministrado',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Indicador.suministrado'
        db.delete_column(u'categorizacion_indicador', 'suministrado')


    def backwards(self, orm):
        # Deleting field 'SubseccionConfig.suministrado'
        db.delete_column(u'categorizacion_subseccionconfig', 'suministrado')

        # Adding field 'Indicador.suministrado'
        db.add_column(u'categorizacion_indicador', 'suministrado',
