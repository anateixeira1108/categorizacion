...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Placa'
        db.create_table(u'categorizacion_placa', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pst', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Pst'])),
            ('documento', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Documento'])),
            ('licencia_asignada', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licencias.LicenciaAsignada'])),
        ))
        db.send_create_signal(u'categorizacion', ['Placa'])


    def backwards(self, orm):
        # Deleting model 'Placa'
        db.delete_table(u'categorizacion_placa')
