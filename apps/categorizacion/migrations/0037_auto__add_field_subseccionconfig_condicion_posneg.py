...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubseccionConfig.condicion_posneg'
        db.add_column(u'categorizacion_subseccionconfig', 'condicion_posneg',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubseccionConfig.condicion_posneg'
        db.delete_column(u'categorizacion_subseccionconfig', 'condicion_posneg')
