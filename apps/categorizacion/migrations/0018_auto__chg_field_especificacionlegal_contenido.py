...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EspecificacionLegal.contenido'
        db.alter_column(u'categorizacion_especificacionlegal', 'contenido', self.gf('django.db.models.fields.CharField')(max_length=1024, null=True))

    def backwards(self, orm):

        # Changing field 'EspecificacionLegal.contenido'
        db.alter_column(u'categorizacion_especificacionlegal', 'contenido', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
