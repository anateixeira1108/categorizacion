...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Placa.documento'
        db.alter_column(u'categorizacion_placa', 'documento_id', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Documento'], null=True))

    def backwards(self, orm):

        # Changing field 'Placa.documento'
        db.alter_column(u'categorizacion_placa', 'documento_id', self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['categorizacion.Documento']))
