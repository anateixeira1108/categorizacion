...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ValorRespuestaConfig.puntaje'
        db.delete_column(u'categorizacion_valorrespuestaconfig', 'puntaje')


    def backwards(self, orm):
        # Adding field 'ValorRespuestaConfig.puntaje'
        db.add_column(u'categorizacion_valorrespuestaconfig', 'puntaje',
