...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Categoria.tope_porcentual'
        db.add_column(u'categorizacion_categoria', 'tope_porcentual',
                      self.gf('django.db.models.fields.FloatField')(default=15.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Categoria.tope_porcentual'
        db.delete_column(u'categorizacion_categoria', 'tope_porcentual')
