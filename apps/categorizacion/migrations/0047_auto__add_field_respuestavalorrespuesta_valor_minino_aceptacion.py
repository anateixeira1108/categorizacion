...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RespuestaValorRespuesta.valor_minino_aceptacion'
        db.add_column(u'categorizacion_respuestavalorrespuesta', 'valor_minino_aceptacion',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RespuestaValorRespuesta.valor_minino_aceptacion'
        db.delete_column(u'categorizacion_respuestavalorrespuesta', 'valor_minino_aceptacion')
