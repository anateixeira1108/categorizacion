...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubseccionConfig.creado_en'
        db.add_column(u'categorizacion_subseccionconfig', 'creado_en',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubseccionConfig.creado_en'
        db.delete_column(u'categorizacion_subseccionconfig', 'creado_en_id')
