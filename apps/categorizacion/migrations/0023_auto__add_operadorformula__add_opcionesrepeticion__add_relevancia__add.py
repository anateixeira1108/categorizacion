...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OperadorFormula'
        db.create_table(u'categorizacion_operadorformula', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('representacion', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('aridad', self.gf('django.db.models.fields.PositiveIntegerField')(default=2)),
        ))
        db.send_create_signal(u'categorizacion', ['OperadorFormula'])

        # Adding model 'OpcionesRepeticion'
        db.create_table(u'categorizacion_opcionesrepeticion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'categorizacion', ['OpcionesRepeticion'])

        # Adding model 'Relevancia'
        db.create_table(u'categorizacion_relevancia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Categoria'])),
            ('subseccion_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.SubseccionConfig'])),
        ))
        db.send_create_signal(u'categorizacion', ['Relevancia'])

        # Adding model 'ValorCategoria'
        db.create_table(u'categorizacion_valorcategoria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Categoria'])),
            ('indicador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Indicador'])),
            ('operador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.OperadorFormula'], null=True, blank=True)),
            ('valor_comparacion', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('valor', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'categorizacion', ['ValorCategoria'])

        # Adding model 'IncidenciaCondicional'
        db.create_table(u'categorizacion_incidenciacondicional', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('porcentaje_inferior', self.gf('django.db.models.fields.FloatField')()),
            ('porcentaje_superior', self.gf('django.db.models.fields.FloatField')()),
            ('valor_incidencia', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal(u'categorizacion', ['IncidenciaCondicional'])

        # Adding model 'Incidencia'
        db.create_table(u'categorizacion_incidencia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('incidencia_condicional', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.IncidenciaCondicional'])),
            ('tabulador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Tabulador'])),
        ))
        db.send_create_signal(u'categorizacion', ['Incidencia'])

        # Adding model 'Indicador'
        db.create_table(u'categorizacion_indicador', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('suministrado', self.gf('django.db.models.fields.BooleanField')()),
        ))
        db.send_create_signal(u'categorizacion', ['Indicador'])

        # Adding model 'Repeticion'
        db.create_table(u'categorizacion_repeticion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subseccion_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.SubseccionConfig'])),
            ('categoria', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Categoria'])),
            ('repeticion_esperada', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'categorizacion', ['Repeticion'])

        # Adding model 'ValorIndicador'
        db.create_table(u'categorizacion_valorindicador', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('respuesta_config', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.RespuestaConfig'])),
            ('indicador', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Indicador'])),
            ('operador_derecho', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'operador_derecho', null=True, to=orm['categorizacion.OperadorFormula'])),
            ('operador_izquierdo', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'operador_izquierdo', null=True, to=orm['categorizacion.OperadorFormula'])),
            ('orden', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'categorizacion', ['ValorIndicador'])

        # Adding unique constraint on 'RespuestaTabulador', fields ['solicitud']
        db.create_unique(u'categorizacion_respuestatabulador', ['solicitud_id'])


        # Changing field 'ValorRespuestaConfig.nombre'
        db.alter_column(u'categorizacion_valorrespuestaconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Removing unique constraint on 'RespuestaTabulador', fields ['solicitud']
        db.delete_unique(u'categorizacion_respuestatabulador', ['solicitud_id'])

        # Deleting model 'OperadorFormula'
        db.delete_table(u'categorizacion_operadorformula')

        # Deleting model 'OpcionesRepeticion'
        db.delete_table(u'categorizacion_opcionesrepeticion')

        # Deleting model 'Relevancia'
        db.delete_table(u'categorizacion_relevancia')

        # Deleting model 'ValorCategoria'
        db.delete_table(u'categorizacion_valorcategoria')

        # Deleting model 'IncidenciaCondicional'
        db.delete_table(u'categorizacion_incidenciacondicional')

        # Deleting model 'Incidencia'
        db.delete_table(u'categorizacion_incidencia')

        # Deleting model 'Indicador'
        db.delete_table(u'categorizacion_indicador')

        # Deleting model 'Repeticion'
        db.delete_table(u'categorizacion_repeticion')

        # Deleting model 'ValorIndicador'
        db.delete_table(u'categorizacion_valorindicador')
    ...
    models = {
        ...
        u'categorizacion.operadorformula': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'representacion': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        ...
        u'categorizacion.valorindicador': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'indicador': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['categorizacion.Indicador']"}),
            'operador_derecho': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'operador_derecho'", 'null': 'True', 'to': u"orm['categorizacion.OperadorFormula']"}),
            'operador_izquierdo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'operador_izquierdo'", 'null': 'True', 'to': u"orm['categorizacion.OperadorFormula']"}),
