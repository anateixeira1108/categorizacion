...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoAspectoFundamental'
        db.create_table(u'categorizacion_tipoaspectofundamental', (
        ...
        db.send_create_signal(u'categorizacion', ['TipoAspectoFundamental'])


    def backwards(self, orm):
        # Deleting model 'TipoAspectoFundamental'
        db.delete_table(u'categorizacion_tipoaspectofundamental')
