...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Valoracion.puntaje'
        db.alter_column(u'categorizacion_valoracion', 'puntaje', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Valoracion.puntaje'
        db.alter_column(u'categorizacion_valoracion', 'puntaje', self.gf('django.db.models.fields.FloatField')())
