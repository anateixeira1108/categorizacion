...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PstCategoriaDocumentoCompuesto.calificacion_definitiva'
        db.add_column(u'categorizacion_pstcategoriadocumentocompuesto', 'calificacion_definitiva',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'PstCategoriaDocumentoCompuesto.documento'
        db.alter_column(u'categorizacion_pstcategoriadocumentocompuesto', 'documento_id', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Documento'], unique=True, null=True))

    def backwards(self, orm):
        # Deleting field 'PstCategoriaDocumentoCompuesto.calificacion_definitiva'
        db.delete_column(u'categorizacion_pstcategoriadocumentocompuesto', 'calificacion_definitiva')


        # Changing field 'PstCategoriaDocumentoCompuesto.documento'
        db.alter_column(u'categorizacion_pstcategoriadocumentocompuesto', 'documento_id', self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['categorizacion.Documento'], unique=True))
