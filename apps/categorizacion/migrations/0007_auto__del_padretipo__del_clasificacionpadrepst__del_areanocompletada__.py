...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Encuesta.tipo_pst'
        db.alter_column(u'categorizacion_encuesta', 'tipo_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licencias.TipoLicencia']))

        # Changing field 'Categoria.clasificacion_pst'
        db.alter_column(u'categorizacion_categoria', 'tipo_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licencias.TipoLicencia']))

        # Changing field 'Tabulador.tipo_pst'
        db.alter_column(u'categorizacion_tabulador', 'tipo_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licencias.TipoLicencia']))
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'categorizacion_clasificacionpadrepst', (
            ...
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('abreviacion', self.gf('django.db.models.fields.CharField')(max_length=5, unique=True)),
        ))
        ...
        # Changing field 'Encuesta.tipo_pst'
        db.alter_column(u'categorizacion_encuesta', 'tipo_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.TipoPst']))

        # Changing field 'Categoria.clasificacion_pst'
        db.alter_column(u'categorizacion_categoria', 'clasificacion_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.ClasificacionPadrePst']))

        # Changing field 'Tabulador.tipo_pst'
        db.alter_column(u'categorizacion_tabulador', 'tipo_pst_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.ClasificacionPadrePst']))
    ...
    models = {
        ...
        u'categorizacion.categoria': {
            ...
            'clasificacion_pst': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['licencias.TipoLicencia']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
