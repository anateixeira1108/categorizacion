...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Notificacion.asunto'
        db.alter_column(u'categorizacion_notificacion', 'asunto', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Notificacion.asunto'
        db.alter_column(u'categorizacion_notificacion', 'asunto', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
    ...
    models = {
        ...
        u'categorizacion.notificacion': {
            ...
            'archivo': ('utils.validate_files.ContentTypeRestrictedFileField', [], {'max_length': '255', 'null': 'True'}),
