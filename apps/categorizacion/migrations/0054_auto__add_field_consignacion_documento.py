...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consignacion.documento'
        db.add_column(u'categorizacion_consignacion', 'documento',
                      self.gf('mintur.fields.BigForeignKey')(default=1, to=orm['categorizacion.Documento']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consignacion.documento'
        db.delete_column(u'categorizacion_consignacion', 'documento_id')
