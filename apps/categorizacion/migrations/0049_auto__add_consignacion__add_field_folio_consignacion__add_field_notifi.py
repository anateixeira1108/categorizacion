...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Consignacion'
        db.create_table(u'categorizacion_consignacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pst', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Pst'])),
            ('sucursal', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Sucursales'], null=True, blank=True)),
            ('solicitud_libro', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.SolicitudLibro'])),
            ('estatus', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.Estatus'])),
            ('funcionario', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'funcionarioconsignacion', null=True, to=orm['categorizacion.Funcionario'])),
        ))
        db.send_create_signal(u'categorizacion', ['Consignacion'])

        # Adding field 'Folio.consignacion'
        db.add_column(u'categorizacion_folio', 'consignacion',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Consignacion'], null=True),
                      keep_default=False)

        # Adding field 'Notificacion.solicitud_libro'
        db.add_column(u'categorizacion_notificacion', 'solicitud_libro',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.SolicitudLibro'], null=True),
                      keep_default=False)


        # Changing field 'Notificacion.solicitud'
        db.alter_column(u'categorizacion_notificacion', 'solicitud_id', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Solicitud'], null=True))

    def backwards(self, orm):
        # Deleting model 'Consignacion'
        db.delete_table(u'categorizacion_consignacion')

        # Deleting field 'Folio.consignacion'
        db.delete_column(u'categorizacion_folio', 'consignacion_id')

        # Deleting field 'Notificacion.solicitud_libro'
        db.delete_column(u'categorizacion_notificacion', 'solicitud_libro_id')


        # Changing field 'Notificacion.solicitud'
        db.alter_column(u'categorizacion_notificacion', 'solicitud_id', self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['categorizacion.Solicitud']))
