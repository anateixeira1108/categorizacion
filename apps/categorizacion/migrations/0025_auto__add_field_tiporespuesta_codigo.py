...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoRespuesta.codigo'
        db.add_column(u'categorizacion_tiporespuesta', 'codigo',
                      self.gf('django.db.models.fields.CharField')(default='TR_NAME', max_length=u'10'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoRespuesta.codigo'
        db.delete_column(u'categorizacion_tiporespuesta', 'codigo')
