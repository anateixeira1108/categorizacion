...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TipoIcono', fields ['representacion']
        db.delete_unique(u'categorizacion_tipoicono', ['representacion'])

        # Removing unique constraint on 'TipoIcono', fields ['nombre']
        db.delete_unique(u'categorizacion_tipoicono', ['nombre'])

        # Adding unique constraint on 'TipoIcono', fields ['tipo_pst']
        db.create_unique(u'categorizacion_tipoicono', ['tipo_pst_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'TipoIcono', fields ['tipo_pst']
        db.delete_unique(u'categorizacion_tipoicono', ['tipo_pst_id'])

        # Adding unique constraint on 'TipoIcono', fields ['nombre']
        db.create_unique(u'categorizacion_tipoicono', ['nombre'])

        # Adding unique constraint on 'TipoIcono', fields ['representacion']
        db.create_unique(u'categorizacion_tipoicono', ['representacion'])
    ...
    models = {
        ...
        u'categorizacion.tipoicono': {
            'Meta': {'object_name': 'TipoIcono'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'representacion': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'tipo_pst': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['licencias.TipoLicencia']", 'unique': 'True'})
        },
