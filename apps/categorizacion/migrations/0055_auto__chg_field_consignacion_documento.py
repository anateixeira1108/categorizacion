...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consignacion.documento'
        db.alter_column(u'categorizacion_consignacion', 'documento_id', self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Documento'], null=True))

    def backwards(self, orm):

        # Changing field 'Consignacion.documento'
        db.alter_column(u'categorizacion_consignacion', 'documento_id', self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['categorizacion.Documento']))
