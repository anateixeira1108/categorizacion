...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoEspecificacion.abreviacion'
        db.add_column(u'categorizacion_tipoespecificacion', 'abreviacion',
                      self.gf('django.db.models.fields.CharField')(max_length=5, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoEspecificacion.abreviacion'
        db.delete_column(u'categorizacion_tipoespecificacion', 'abreviacion')
    ...
    models = {
        ...
        u'categorizacion.tipoespecificacion': {
            ...
            'abreviacion': ('django.db.models.fields.CharField', [], {'max_length': '5', 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'})
        },
