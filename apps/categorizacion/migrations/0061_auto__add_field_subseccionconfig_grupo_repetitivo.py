...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubseccionConfig.grupo_repetitivo'
        db.add_column(u'categorizacion_subseccionconfig', 'grupo_repetitivo',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubseccionConfig.grupo_repetitivo'
        db.delete_column(u'categorizacion_subseccionconfig', 'grupo_repetitivo')
