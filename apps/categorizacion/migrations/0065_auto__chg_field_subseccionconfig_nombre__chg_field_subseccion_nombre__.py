...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubseccionConfig.nombre'
        db.alter_column(u'categorizacion_subseccionconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'Subseccion.nombre'
        db.alter_column(u'categorizacion_subseccion', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'SeccionConfig.nombre'
        db.alter_column(u'categorizacion_seccionconfig', 'nombre', self.gf('django.db.models.fields.TextField')(max_length=2048))

        # Changing field 'RespuestaConfig.nombre'
        db.alter_column(u'categorizacion_respuestaconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=2048))

        # Changing field 'AspectoFundamental.nombre'
        db.alter_column(u'categorizacion_aspectofundamental', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=2048))
        # Adding field 'Indicador.tabulador'
        db.add_column(u'categorizacion_indicador', 'tabulador',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=100, to=orm['categorizacion.Tabulador']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SubseccionConfig.nombre'
        db.alter_column(u'categorizacion_subseccionconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'Subseccion.nombre'
        db.alter_column(u'categorizacion_subseccion', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'SeccionConfig.nombre'
        db.alter_column(u'categorizacion_seccionconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'RespuestaConfig.nombre'
        db.alter_column(u'categorizacion_respuestaconfig', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'AspectoFundamental.nombre'
        db.alter_column(u'categorizacion_aspectofundamental', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))
        # Deleting field 'Indicador.tabulador'
        db.delete_column(u'categorizacion_indicador', 'tabulador_id')
    ...
    models = {
        ...
        u'categorizacion.aspectofundamental': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '2048'}),
        ...
        u'categorizacion.aspectofundamentalconfig': {
            ...
            'peso_porcentual': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'categorizacion.credencialesotorgadas': {
            'Meta': {'object_name': 'CredencialesOtorgadas'},
            'cargo': ('django.db.models.fields.CharField', [], {'max_length': '150', 'null': 'True'}),
            'coletilla': ('django.db.models.fields.TextField', [], {'max_length': '500'}),
            'creado_el': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tiene_firma_delegada': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'user': ('mintur.fields.BigForeignKey', [], {'to': u"orm['cuentas.MinturUser']", 'null': 'True'})
        },
        ...
        u'categorizacion.documento': {
            ...
            'coletillado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'coletillado_el': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            ...
            'firmado_el': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'firmado_por': ('mintur.fields.BigForeignKey', [], {'to': u"orm['cuentas.MinturUser']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
        ...
        u'categorizacion.seccionconfig': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.TextField', [], {'max_length': '2048'}),
        ...
        u'categorizacion.subseccionconfig': {
            ...
            'creado_en': ('mintur.fields.BigForeignKey', [], {'to': u"orm['categorizacion.Solicitud']", 'null': 'True'}),
            'grupo_repetitivo': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '2048'}),
            ...
            'suministrado': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'categorizacion.valorrespuesta': {
            ...
            'valor_respuesta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['categorizacion.ValorRespuestaConfig']", 'null': 'True', 'blank': 'True'})
        },
