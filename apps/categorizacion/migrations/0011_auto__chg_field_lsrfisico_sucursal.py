...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'categorizacion_lsrfisico', 'sucursal_id', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Sucursales'], null=True))

    def backwards(self, orm):

        # Changing field 'LsrFisico.sucursal'
        db.alter_column(u'categorizacion_lsrfisico', 'sucursal_id', self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['registro.Sucursales']))
