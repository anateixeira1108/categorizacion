...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SolicitudLibro.fecha_culminacion'
        db.add_column(u'categorizacion_solicitudlibro', 'fecha_culminacion',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SolicitudLibro.fecha_culminacion'
        db.delete_column(u'categorizacion_solicitudlibro', 'fecha_culminacion')
