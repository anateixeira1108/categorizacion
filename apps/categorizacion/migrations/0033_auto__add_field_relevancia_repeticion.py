...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relevancia.repeticion'
        db.add_column(u'categorizacion_relevancia', 'repeticion',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relevancia.repeticion'
        db.delete_column(u'categorizacion_relevancia', 'repeticion')
