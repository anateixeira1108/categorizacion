...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OperadorFormula.logico'
        db.add_column(u'categorizacion_operadorformula', 'logico',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OperadorFormula.logico'
        db.delete_column(u'categorizacion_operadorformula', 'logico')
