...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Consignacion.lsr_fisico'
        db.add_column(u'categorizacion_consignacion', 'lsr_fisico',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categorizacion.LsrFisico']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Consignacion.lsr_fisico'
        db.delete_column(u'categorizacion_consignacion', 'lsr_fisico_id')
