...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ValorRespuesta.valor_respuesta'
        db.alter_column(u'categorizacion_valorrespuesta', 'valor_respuesta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.ValorRespuestaConfig'], null=True))

    def backwards(self, orm):

        # Changing field 'ValorRespuesta.valor_respuesta'
        db.alter_column(u'categorizacion_valorrespuesta', 'valor_respuesta_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categorizacion.ValorRespuestaConfig']))
