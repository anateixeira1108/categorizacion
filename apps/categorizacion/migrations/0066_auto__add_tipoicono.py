...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoIcono'
        db.create_table(u'categorizacion_tipoicono', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('representacion', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('nombre', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('tipo_pst', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['licencias.TipoLicencia'])),
        ))
        db.send_create_signal(u'categorizacion', ['TipoIcono'])


    def backwards(self, orm):
        # Deleting model 'TipoIcono'
        db.delete_table(u'categorizacion_tipoicono')
    ...
    models = {
        ...
        u'categorizacion.tipoicono': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'representacion': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'tipo_pst': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['licencias.TipoLicencia']"})
        },
