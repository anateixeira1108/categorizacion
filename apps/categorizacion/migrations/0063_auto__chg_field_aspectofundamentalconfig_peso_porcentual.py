...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AspectoFundamentalConfig.peso_porcentual'
        db.alter_column(u'categorizacion_aspectofundamentalconfig', 'peso_porcentual', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'AspectoFundamentalConfig.peso_porcentual'
        db.alter_column(u'categorizacion_aspectofundamentalconfig', 'peso_porcentual', self.gf('django.db.models.fields.FloatField')(default=None))
