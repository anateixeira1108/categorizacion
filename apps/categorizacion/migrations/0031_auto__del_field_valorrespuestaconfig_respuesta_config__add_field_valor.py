...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ValorRespuestaConfig.respuesta_config'
        db.delete_column(u'categorizacion_valorrespuestaconfig', 'respuesta_config_id')

        # Adding field 'ValorRespuestaConfig.categoria'
        db.add_column(u'categorizacion_valorrespuestaconfig', 'categoria',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['categorizacion.Categoria'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ValorRespuestaConfig.respuesta_config'
        db.add_column(u'categorizacion_valorrespuestaconfig', 'respuesta_config',
                      self.gf('mintur.fields.BigForeignKey')(default=1, to=orm['categorizacion.RespuestaConfig']),
                      keep_default=False)

        # Deleting field 'ValorRespuestaConfig.categoria'
        db.delete_column(u'categorizacion_valorrespuestaconfig', 'categoria_id')
    ...
    models = {
        ...
        u'categorizacion.notificacion': {
            ...
            'archivo': ('utils.validate_files.ContentTypeRestrictedFileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
