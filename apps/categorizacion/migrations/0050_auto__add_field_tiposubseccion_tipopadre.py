...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoSubseccion.tipopadre'
        db.add_column(u'categorizacion_tiposubseccion', 'tipopadre',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categorizacion.Estatus'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoSubseccion.tipopadre'
        db.delete_column(u'categorizacion_tiposubseccion', 'tipopadre_id')
    ...
    models = {
        ...
        u'categorizacion.tiposubseccion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'tipopadre': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['categorizacion.Estatus']", 'null': 'True', 'blank': 'True'})
        },
