...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entrada.encuesta'
        db.delete_column(u'categorizacion_entrada', 'encuesta_id')


    def backwards(self, orm):
        # Adding field 'Entrada.encuesta'
        db.add_column(u'categorizacion_entrada', 'encuesta',
                      self.gf('mintur.fields.BigForeignKey')(default=None, related_name=u'related_forced_name_again', null=True, to=orm['categorizacion.Encuesta'], blank=True),
                      keep_default=False)
