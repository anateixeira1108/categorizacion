...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AspectoFundamentalConfig.tipo_aspecto'
        db.add_column(u'categorizacion_aspectofundamentalconfig', 'tipo_aspecto',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categorizacion.TipoAspectoFundamental']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AspectoFundamentalConfig.tipo_aspecto'
        db.delete_column(u'categorizacion_aspectofundamentalconfig', 'tipo_aspecto_id')
