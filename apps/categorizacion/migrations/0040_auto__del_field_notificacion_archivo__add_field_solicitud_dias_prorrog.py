...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notificacion.archivo'
        db.delete_column(u'categorizacion_notificacion', 'archivo')

        # Adding field 'Solicitud.dias_prorroga'
        db.add_column(u'categorizacion_solicitud', 'dias_prorroga',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Documento.firmado'
        db.add_column(u'categorizacion_documento', 'firmado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Documento.plantilla_documento'
        db.alter_column(u'categorizacion_documento', 'plantilla_documento_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.PlantillaDocumento'], null=True))

    def backwards(self, orm):
        # Adding field 'Notificacion.archivo'
        db.add_column(u'categorizacion_notificacion', 'archivo',
                      self.gf('utils.validate_files.ContentTypeRestrictedFileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Solicitud.dias_prorroga'
        db.delete_column(u'categorizacion_solicitud', 'dias_prorroga')

        # Deleting field 'Documento.firmado'
        db.delete_column(u'categorizacion_documento', 'firmado')


        # Changing field 'Documento.plantilla_documento'
        db.alter_column(u'categorizacion_documento', 'plantilla_documento_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['categorizacion.PlantillaDocumento']))
