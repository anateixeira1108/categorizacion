...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AspectoFundamentalConfig.peso_porcentual'
        db.delete_column(u'categorizacion_aspectofundamentalconfig', 'peso_porcentual')


        # Changing field 'NotificacionBackup.asunto'
        db.alter_column(u'categorizacion_notificacionbackup', 'asunto', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):
        # Adding field 'AspectoFundamentalConfig.peso_porcentual'
        db.add_column(u'categorizacion_aspectofundamentalconfig', 'peso_porcentual',
                      self.gf('django.db.models.fields.FloatField')(default=2),
                      keep_default=False)


        # Changing field 'NotificacionBackup.asunto'
        db.alter_column(u'categorizacion_notificacionbackup', 'asunto', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
