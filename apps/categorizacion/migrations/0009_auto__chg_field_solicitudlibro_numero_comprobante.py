...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SolicitudLibro.numero_comprobante'
        db.alter_column(u'categorizacion_solicitudlibro', 'numero_comprobante', self.gf('django.db.models.fields.BigIntegerField')(unique=True, null=True))

    def backwards(self, orm):

        # Changing field 'SolicitudLibro.numero_comprobante'
        db.alter_column(u'categorizacion_solicitudlibro', 'numero_comprobante', self.gf('django.db.models.fields.PositiveIntegerField')(unique=True, null=True))
