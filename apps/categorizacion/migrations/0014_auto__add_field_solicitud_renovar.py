...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Solicitud.renovar'
        db.add_column(u'categorizacion_solicitud', 'renovar',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Solicitud.renovar'
        db.delete_column(u'categorizacion_solicitud', 'renovar')
