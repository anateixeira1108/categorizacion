...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relevancia.operador_logico'
        db.add_column(u'categorizacion_relevancia', 'operador_logico',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['categorizacion.OperadorFormula'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relevancia.operador_logico'
        db.delete_column(u'categorizacion_relevancia', 'operador_logico_id')
