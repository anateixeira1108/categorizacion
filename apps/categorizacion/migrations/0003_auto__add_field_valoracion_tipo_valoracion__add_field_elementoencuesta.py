...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Valoracion.tipo_valoracion'
        db.add_column(u'categorizacion_valoracion', 'tipo_valoracion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categorizacion.TipoValoracion']),
                      keep_default=False)

        # Adding field 'ElementoEncuesta.tipo_valoracion'
        db.add_column(u'categorizacion_elementoencuesta', 'tipo_valoracion',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['categorizacion.TipoValoracion']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Valoracion.tipo_valoracion'
        db.delete_column(u'categorizacion_valoracion', 'tipo_valoracion_id')

        # Deleting field 'ElementoEncuesta.tipo_valoracion'
        db.delete_column(u'categorizacion_elementoencuesta', 'tipo_valoracion_id')
