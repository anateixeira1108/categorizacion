...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consignacion.sucursal'
        db.delete_column(u'categorizacion_consignacion', 'sucursal_id')

        # Deleting field 'Consignacion.pst'
        db.delete_column(u'categorizacion_consignacion', 'pst_id')

        # Adding field 'Consignacion.observacion'
        db.add_column(u'categorizacion_consignacion', 'observacion',
                      self.gf('django.db.models.fields.TextField')(default=u'No se han registrado observaciones'),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Consignacion.sucursal'
        db.add_column(u'categorizacion_consignacion', 'sucursal',
                      self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Sucursales'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Consignacion.pst'
        db.add_column(u'categorizacion_consignacion', 'pst',
                      self.gf('mintur.fields.BigForeignKey')(default=None, to=orm['registro.Pst']),
                      keep_default=False)

        # Deleting field 'Consignacion.observacion'
        db.delete_column(u'categorizacion_consignacion', 'observacion')
