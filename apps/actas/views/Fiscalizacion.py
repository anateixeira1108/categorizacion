...
from apps.fiscalizacion.models import Fiscalizacion as modelo
...
class FiscalizacionObject(object):
    """
    ...
    def get_codigo_fiscalizacion(self):
    ...
    def get_object_fiscalizacion(self):
        return modelo.objects.get(pk=self.get_codigo_fiscalizacion())
    ...
    def get_object_providencia(self):
        try:
            # obtiene el acta providencia de esa fiscalizacion que no este anulada
            ...
            # solo tiene providencia ANULADA o ninguna, puede ingresar otra providencia
    ...
    def redirigir(self):
        ...
        """
        return redirect('funcionario_detalle_fiscalizacion', pk=self.get_codigo_fiscalizacion())
    ...
    def get_utils_codigo(self):
        ...
        """
        # se realiza una verificacion de los parametros
        ...
        data = Storage(
            ...
            objeto=self.get_object_fiscalizacion()
        )

        #Clase factory utilizada para generar el codigo y otros metodos utiles para fiscalizacion
