...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'verificacion_verificacion', (
            ...
            ('tipo_verificacion', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ...
            ('conclusiones', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'verificacion', ['Verificacion'])

        # Adding model 'FuncionariosVerificacion'
        db.create_table(u'verificacion_funcionariosverificacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('verificacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['verificacion.Verificacion'])),
            ('asignado_el', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'verificacion', ['FuncionariosVerificacion'])


    def backwards(self, orm):
        # Deleting model 'Verificacion'
        db.delete_table(u'verificacion_verificacion')

        # Deleting model 'FuncionariosVerificacion'
        db.delete_table(u'verificacion_funcionariosverificacion')
    ...
    models = {
        ...
        u'verificacion.funcionariosverificacion': {
            'Meta': {'object_name': 'FuncionariosVerificacion'},
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'verificacion': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['verificacion.Verificacion']"})
        },
