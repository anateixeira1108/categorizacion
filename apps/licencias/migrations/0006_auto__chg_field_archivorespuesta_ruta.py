...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ArchivoRespuesta.ruta'
        db.alter_column(u'licencias_archivorespuesta', 'ruta', self.gf('utils.validate_files.ContentTypeRestrictedFileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ArchivoRespuesta.ruta'
        db.alter_column(u'licencias_archivorespuesta', 'ruta', self.gf('django.db.models.fields.CharField')(default=None, max_length=255))
