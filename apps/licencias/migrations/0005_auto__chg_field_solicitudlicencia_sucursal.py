...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SolicitudLicencia.sucursal'
        db.alter_column(u'licencias_solicitudlicencia', 'sucursal_id', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Sucursales'], null=True))

    def backwards(self, orm):

        # Changing field 'SolicitudLicencia.sucursal'
        db.alter_column(u'licencias_solicitudlicencia', 'sucursal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.Sucursales'], null=True))
