...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LicenciaAsignada.sucursal'
        db.alter_column(u'licencias_licenciaasignada', 'sucursal_id', self.gf('mintur.fields.BigForeignKey')(to=orm['registro.Sucursales'], null=True))

    def backwards(self, orm):

        # Changing field 'LicenciaAsignada.sucursal'
        db.alter_column(u'licencias_licenciaasignada', 'sucursal_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registro.Sucursales'], null=True))
    ...
    models = {
        ...
        u'licencias.archivorespuesta': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'ruta': ('utils.validate_files.ContentTypeRestrictedFileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
