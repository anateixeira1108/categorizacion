...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Fiscalizacion'
        db.create_table(u'fiscalizacion_fiscalizacion', (
        ...
        db.send_create_signal(u'fiscalizacion', ['Fiscalizacion'])

        # Adding model 'FuncionariosFiscalizacion'
        db.create_table(u'fiscalizacion_funcionariosfiscalizacion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('fiscalizacion', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fiscalizacion.Fiscalizacion'])),
            ('asignado_el', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'fiscalizacion', ['FuncionariosFiscalizacion'])


    def backwards(self, orm):
        # Deleting model 'Fiscalizacion'
        db.delete_table(u'fiscalizacion_fiscalizacion')

        # Deleting model 'FuncionariosFiscalizacion'
        db.delete_table(u'fiscalizacion_funcionariosfiscalizacion')
