...
sys.path.append('/srv/www/repos/master/')
# sys.path.append('/srv/www/repos/master/mintur/')
...
os.environ['PYTHON_EGG_CACHE'] = '/srv/www/repos/master/.python-egg'
os.environ['DJANGO_SETTINGS_MODULE'] = 'settings.master'
